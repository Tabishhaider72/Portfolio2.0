...
const ProjectsPage = () => {
  ...
  return (
    <section
      className="min-h-screen flex items-center bg-white dark:bg-neutral-100"
      ref={containerRef}
    >
      <div className="container mx-auto px-4 py-24 md:py-32">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10 mb-14">
          ...
          <h1 className="banner-title max-w-[900px] leading-[0.95] text-5xl sm:text-7xl md:text-[80px] font-anton text-black uppercase tracking-tight">
